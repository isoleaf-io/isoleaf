...
public sealed class SmartBuildAndParseE2ETests : IClassFixture<BackendWebAppFactory>
{
    private readonly HttpClient _client;
    public SmartBuildAndParseE2ETests(BackendWebAppFactory f) => _client = f.CreateClient();
